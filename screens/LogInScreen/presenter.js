    ...
    <StatusBar barStyle={"light-content"} />
      ...
      <View style={styles.content}>
        <TextInput placeholder="Username" style={styles.textInput} 
            ...
            value={props.username} onChangeText={props.changeUsername}
            />
        <TextInput 
            ...
            returnKeyType={"send"}    
            onSubmitEditing={props.submit} //내가 이 키를 누를 떄마다 시작하는 이벤트    
...
const styles = StyleSheet.create({
    ...
    textInput : {
        height: 50,
        borderColor: "#bbb",
        borderWidth: StyleSheet.hairlineWidth, // StyleSheet.hairlineWidth 더 얇은걸 원한다면
        width: width - 80,
        borderRadius: 5,
        marginBottom: 15,
